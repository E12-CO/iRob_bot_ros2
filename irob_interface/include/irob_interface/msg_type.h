...
// Defined various parameter data length
#define PARAM_KP_SIZE		4
#define PARAM_KI_SIZE		4
#define PARAM_KD_SIZE		4
#define PARAM_KFF_SIZE		4
#define PARAM_KPIDFF_SIZE	16
#define PARAM_CTRL_MIN		4
#define PARAM_CTRL_MAX		4
#define PARAM_CTRL_MINMAX	8
#define PARAM_ENCCPR_SIZE	4
#define PARAM_GRRATIO_SIZE	4
